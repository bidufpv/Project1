...
// import { db } from '@/lib/auth/firebase';
// import { collection, doc, getDoc, onSnapshot, updateDoc } from 'firebase/firestore'; // Firebase functions for Firestore
// import useSWRSubscription from 'swr/subscription'; // SWR's subscription-based hook

// export function useProducts() {
//   // useSWRSubscription listens to real-time updates using a custom subscription
//   const { data, error } = useSWRSubscription(
//     ['products'], // The key for SWR's cache (used for data caching and revalidation)
